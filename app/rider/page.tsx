...
import { Users, ArrowLeft, CheckCircle, MapPin } from 'lucide-react';
...
export default function RiderPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.error('Error submitting rider information:', error);
      alert('Failed to submit rider information. Please try again.');
    } finally {
      setIsSubmitting(false);
    }
  };
        ...
        <Card className="w-full max-w-md text-center">
          ...
          <CardContent className="space-y-4">
            <p className="text-gray-600">
              Thank you for requesting a ride! Your information has been submitted successfully.
            </p>
            <p className="text-sm text-gray-500">
              We'll match you with a driver who can provide transportation to King Fahad Mosque.
            </p>
          ...
          <CardContent className="p-6">
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Select value={formData.pickup_area} onValueChange={(value: string) => handleInputChange('pickup_area', value)}>
                  <SelectTrigger className="bg-white border-gray-300 text-gray-900">
                    <SelectValue placeholder="Select pickup area" />
                  </SelectTrigger>
                  <SelectContent className="bg-white border-gray-200">
                    {PICKUP_AREAS.map((area: string) => (
